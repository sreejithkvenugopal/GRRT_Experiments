...
def plot_bmmv_omp_snr_sweep_results(results,plot_format='2_2'):
    ...
    p=results['p']
    L=results['L']
    l_block=results['l_block']
    k_block=results['k_block']
    SNR=results['SNR']
    ...
    PE_variance2=results['PE_variance2'];PE_spice=results['PE_spice'];
    ...
    Recall_variance2=results['Recall_variance2'];Recall_spice=results['Recall_spice'];
    ...
    if plot_format=='2_2':
        ...
        plt.plot(SNR,Recall_variance2,'go-',label=r'BMMV-OMP($||{\bf W}||_F$)',linewidth=linewidth,markersize=markersize)
        ...
        plt.plot(SNR,Precision_sparsity,'m^-',label=r'BMMV-OMP($K_{block}$)',linewidth=linewidth,markersize=markersize)
        plt.legend(fontsize=fontsize)
        plt.grid()
        plt.xlabel('SNR(DB)',fontsize=label_fontsize)
        ...
        plt.plot(SNR,PMD_variance,'md-',label=r'BMMV-OMP($\sigma^2$)',linewidth=linewidth,markersize=markersize)
        ...
        plt.xticks(fontsize=xticksize)
        plt.yticks(fontsize=yticksize)
        plt.plot(SNR,PFD_cv,'r+-', label='CV',linewidth=linewidth,markersize=markersize)
        ...
        plt.semilogy(SNR,MSE_sparsity,'m^-',label=r'BMMV_OMP($K_{block}$)',linewidth=linewidth,markersize=markersize)
        plt.legend(fontsize=fontsize)
        plt.grid()
        plt.xlabel('SNR(DB)',fontsize=label_fontsize)
        plt.ylabel('NMSE',fontsize=label_fontsize)
...
#         plt.xticks(fontsize=xticksize)
#         plt.yticks(fontsize=yticksize)
#         plt.semilogy(SNR,PE_cv,'r+-', linewidth=linewidth,markersize=markersize)
#         plt.semilogy(SNR,PE_alpha1,'bs-',linewidth=linewidth,markersize=markersize)
#         plt.semilogy(SNR,PE_alpha2,'k*-',label=r'GRRT($\alpha=0.01$)',linewidth=linewidth,markersize=markersize)
#         plt.semilogy(SNR,PE_variance,'md-',label=r'SOMP($\sigma^2$)',linewidth=linewidth,markersize=markersize)
#         plt.semilogy(SNR,PE_variance2,'go-',linewidth=linewidth,markersize=markersize)
#         plt.semilogy(SNR,PE_spice,'r>-',linewidth=linewidth,markersize=markersize)
#         plt.semilogy(SNR,PE_sparsity,'m^-',linewidth=linewidth,markersize=markersize)
#         plt.legend(fontsize=fontsize)
#         plt.grid()
#         plt.xlabel('SNR(DB)',fontsize=label_fontsize)
#         plt.ylabel('PE',fontsize=label_fontsize)

        plt.subplot(1,3,2)
        plt.xticks(fontsize=xticksize)
        plt.yticks(fontsize=yticksize)
        plt.plot(SNR,Recall_cv,'r+-', label='CV',linewidth=linewidth,markersize=markersize)
        plt.plot(SNR,Recall_alpha1,'bs-',linewidth=linewidth,markersize=markersize)
        plt.plot(SNR,Recall_alpha2,'k*-',linewidth=linewidth,markersize=markersize)
        plt.plot(SNR,Recall_variance,'md-',label=r'BMMV_OMP($\sigma^2$)',linewidth=linewidth,markersize=markersize)
        plt.plot(SNR,Recall_variance2,'go-',label=r'BMMV_OMP($||{\bf W}||_F$)',linewidth=linewidth,markersize=markersize)
        ...
        plt.plot(SNR,1-np.array(PE_cv),'r+-', linewidth=linewidth,markersize=markersize)
        plt.plot(SNR,1-np.array(PE_alpha1),'bs-',linewidth=linewidth,markersize=markersize)
        plt.plot(SNR,1-np.array(PE_alpha2),'k*-',linewidth=linewidth,markersize=markersize)
        plt.plot(SNR,1-np.array(PE_variance),'md-',linewidth=linewidth,markersize=markersize)
        plt.plot(SNR,1-np.array(PE_variance2),'go-',linewidth=linewidth,markersize=markersize)
        #plt.plot(SNR,Precision_spice,'r>-',linewidth=linewidth,markersize=markersize)
        plt.plot(SNR,1-np.array(PE_sparsity),'m^-',linewidth=linewidth,markersize=markersize)
    ...
    file_name='BMMV_OMP_SNR_sweep_'+matrix_type+'_'+plot_format+'.eps'
    plt.savefig(file_name,bbox_inches='tight')
    print('figure saved to {}'.format(file_name))
    file_name='BMMV_OMP_SNR_sweep_'+matrix_type+'_'+plot_format+'.png'
...
if __name__=='__main__':
    ...
    with open(args.result_file_name) as f:
        results=json.load(f)
    plot_bmmv_omp_snr_sweep_results(results,'2_2')
    plot_bmmv_omp_snr_sweep_results(results,'1_4')
