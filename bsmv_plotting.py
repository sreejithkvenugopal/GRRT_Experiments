...
def plot_bomp_snr_sweep_results(results,plot_format='2_2'):
    ...
    Precision_alpha2=results['Precision_alpha2']; Precision_spice_ls=results['Precision_spice_ls'];
    ...
    if plot_format=='2_2':
        ...
        plt.semilogy(SNR,MSE_spice,'r>-',linewidth=linewidth,markersize=markersize)
        plt.semilogy(SNR,MSE_sparsity,'m^-',linewidth=linewidth,markersize=markersize)
        plt.semilogy(SNR,MSE_spice_ls,'g<-',label='Group SPICE+LS',linewidth=linewidth,markersize=markersize)
        plt.legend(fontsize=fontsize)
        plt.grid()
        plt.xlabel('SNR(DB)',fontsize=label_fontsize)
        plt.ylabel('NMSE',fontsize=label_fontsize)
...
#         plt.semilogy(SNR,PE_alpha2,'k*-',linewidth=linewidth,markersize=markersize)
#         plt.semilogy(SNR,PE_variance,'md-',linewidth=linewidth,markersize=markersize)
...
#         plt.ylabel('PE',fontsize=label_fontsize)
        ...
        plt.plot(SNR,Recall_alpha1,'bs-',linewidth=linewidth,markersize=markersize)
        plt.plot(SNR,Recall_alpha2,'k*-',linewidth=linewidth,markersize=markersize)
        plt.plot(SNR,Recall_variance,'md-',label=r'BOMP($\sigma^2$)',linewidth=linewidth,markersize=markersize)
        plt.plot(SNR,Recall_variance2,'go-',label=r'BOMP($||{\bf W}||_F$)',linewidth=linewidth,markersize=markersize)
        plt.plot(SNR,Recall_spice,'r>-',label='Group SPICE',linewidth=linewidth,markersize=markersize)
        plt.plot(SNR,Recall_sparsity,'m^-',linewidth=linewidth,markersize=markersize)
        plt.plot(SNR,Recall_spice_ls,'g<-',label='Group SPICE+LS',linewidth=linewidth,markersize=markersize)
        plt.legend(fontsize=fontsize)
        plt.grid()
        plt.xlabel('SNR(DB)',fontsize=label_fontsize)
        plt.ylabel('Recall',fontsize=label_fontsize)
        ...
        plt.plot(SNR,Precision_variance2,'go-',linewidth=linewidth,markersize=markersize)
        plt.plot(SNR,Precision_spice,'r>-',linewidth=linewidth,markersize=markersize)
        plt.plot(SNR,Precision_sparsity,'m^-',label=r'BOMP($k_{block}$)',linewidth=linewidth,markersize=markersize)
        plt.plot(SNR,Precision_spice_ls,'g<-',label='Group SPICE+LS',linewidth=linewidth,markersize=markersize)
        plt.legend(fontsize=fontsize)
        plt.grid()
        plt.xlabel('SNR(DB)',fontsize=label_fontsize)
        plt.ylabel('Precision',fontsize=label_fontsize)
    ...
    file_name='BOMP_SNR_sweep_'+matrix_type+'_'+plot_format+'.eps'
    plt.savefig(file_name,bbox_inches='tight')
    print('figure saved to {}'.format(file_name))
    file_name='BOMP_SNR_sweep_'+matrix_type+'_'+plot_format+'.png'
...
if __name__=='__main__':
    ...
    with open(args.result_file_name) as f:
        results=json.load(f)
    plot_bomp_snr_sweep_results(results,'1_4')
    plot_bomp_snr_sweep_results(results,'2_2')
